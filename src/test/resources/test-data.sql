...
INSERT INTO ASSURANCE (numero, dateSouscription, dateAnniversaire, datePrelevement) VALUES ('014UIA38P38', 2018-03-24, 2019-03-24, 2018-07-15);
...
INSERT INTO CLIENT_ASSURANCE(idClient, idAssurance)
      VALUES ((SELECT idClient FROM CLIENT WHERE nom='cathy cathou'),
              (SELECT idAssurance FROM ASSURANCE WHERE idAssurance='014UIA38P38'));
...
INSERT INTO CLIENT_ASSURANCE(idClient, idAssurance)
      VALUES ((SELECT idClient FROM CLIENT WHERE nom='toto cathou'),
              (SELECT idAssurance FROM ASSURANCE WHERE idAssurance='01AIR938J90'));
